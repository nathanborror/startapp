...
class Remote: NSObject {
    ...
    func query<T: RemoteResponse>(_ query: String, token: String?, args: [String: String]? = nil, then: @escaping (RemoteResult<T>) -> Void) {
    ...
    // TODO: This shouldn't know about '{{.Name|titlecase}}'
    func open(_ name: String, ext: String) -> String {
        guard let path = Bundle(identifier: {{.Name|titlecase}}.bundleIdentifier)?.path(forResource: name, ofType: ext) else {
            return ""
        }
